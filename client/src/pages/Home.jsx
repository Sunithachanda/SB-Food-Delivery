    ...
    <div className="HomePage">
      ...
      <div className="home-categories-container">
        ...
        <div className="home-category-card" onClick={()=>navigate('/category/Burger')}>
          <img src="https://www.eatthis.com/wp-content/uploads/sites/4/2024/09/Burger-King-Million-Dollar-Whopper-Finalists.jpg?resize=1536,1024&quality=82&strip=all" alt="" />
          <h5>Burger</h5>
        </div>
